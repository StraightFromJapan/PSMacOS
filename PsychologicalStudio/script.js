...
(function(){
    ...
    async function mountArrangementUI() {
        ...
        // Inform the iframe that it's embedded/integrated via postMessage so the child can unlock itself
        // Use onload to ensure the child is ready to receive messages (same-origin, but postMessage is safe)
        iframe.addEventListener('load', () => {
            try {
                iframe.contentWindow.postMessage({ type: 'ps-integrated', ps_access: '1' }, '*');
            } catch (e) {
                console.warn('Could not postMessage to arrangement iframe:', e);
            }
        });
        ...
        <div class="popup-content">
            <div class="effect-section">
                ...
                <div class="sample-upload">
                    ...
                    <div class="loop-whole-sample-toggle" style="margin-top:8px;">
                        <label style="display:inline-block;margin-right:8px;">Loop behaviour:</label>
                        <label class="switch" style="vertical-align:middle;">
                            <input type="checkbox" id="loop-whole-sample">
                            <span class="slider round"></span>
                        </label>
                        <span style="margin-left:8px;">Loop whole sample (do not stretch to grid)</span>
                    </div>
                </div>
            ...
            <br>
                ...
                <div class="piano-roll-content">
                    ...
                    <option value="sounddesign">Sound Design (Dual Osc)</option>
                        ...
                        <div class="piano-roll-preview-controls">
                            ...
                            <div style="display: inline-flex; align-items: center; margin-left: 10px;">
                                <input type="checkbox" id="piano-roll-delete-mode" style="margin: 0; margin-right: 5px;">
                                <label for="piano-roll-delete-mode" style="margin: 0; cursor: pointer; font-size: 14px;">Delete</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sound-design-controls" style="display:none">
                        ...
                        <!-- MASTER VOLUME -->
                        <div class="sd-row" style="background: rgba(76, 175, 80, 0.15); padding: 10px; border-radius: 6px; margin-bottom: 10px;">
                            <h5 style="margin: 0 0 8px 0; color: #81C784;">Master Volume</h5>
                            <div style="display:flex;align-items:center;gap:8px;justify-content:space-between">
                                <label>Volume</label>
                                <input type="range" id="sd-master-volume" min="0" max="100" value="70" step="1">
                                <span id="sd-master-volume-val">70%</span>
                            </div>
                        </div>
                        
                        <!-- OSCILLATORS CONTAINER -->
                        <div class="sd-row" style="background: rgba(33, 150, 243, 0.15); padding: 10px; border-radius: 6px; margin-bottom: 10px;">
                            <h5 style="margin: 0 0 8px 0; color: #64B5F6;">Oscillators</h5>
                            
                            <!-- OSC 1 -->
                            <div style="background: rgba(33, 150, 243, 0.08); padding: 8px; border-radius: 4px; margin-bottom: 8px;">
                                <div style="display:flex;flex-direction:column;align-items:flex-start;gap:6px; margin-bottom: 8px;">
                                    <label style="color: #64B5F6; font-weight: bold;">Osc 1 Wave</label>
                                ...
                                <div style="display:flex;align-items:center;gap:8px;justify-content:space-between">
                                    <label>Octave</label>
                                    <input type="range" id="sd-osc1-octave" min="-3" max="3" value="0" step="1">
                                    <span id="sd-osc1-octave-val">0</span>
                                </div>
                                <br>
                                <div style="display:flex;align-items:center;gap:8px;justify-content:space-between">
                                    <label>Phase</label>
                                    <input type="range" id="sd-osc1-phase" min="0" max="360" value="0" step="1">
                                    <span id="sd-osc1-phase-val">0°</span>
                                </div>
                            </div>
                            
                            <!-- OSC 2 -->
                            <div style="background: rgba(33, 150, 243, 0.08); padding: 8px; border-radius: 4px;">
                                <div style="display:flex;flex-direction:column;align-items:flex-start;gap:6px; margin-bottom: 8px;">
                                    <label style="color: #64B5F6; font-weight: bold;">Osc 2 Wave</label>
                                ...
                                <div style="display:flex;align-items:center;gap:8px;justify-content:space-between">
                                    <label>Octave</label>
                                    <input type="range" id="sd-osc2-octave" min="-3" max="3" value="0" step="1">
                                    <span id="sd-osc2-octave-val">0</span>
                                </div>
                                <br>
                                <div style="display:flex;align-items:center;gap:8px;justify-content:space-between">
                                    <label>Phase</label>
                                    <input type="range" id="sd-osc2-phase" min="0" max="360" value="0" step="1">
                                    <span id="sd-osc2-phase-val">0°</span>
                                </div>
                            </div>
                        </div>
                        
                        <!-- FILTER CONTAINER -->
                        <div class="sd-row" style="background: rgba(255, 193, 7, 0.15); padding: 10px; border-radius: 6px; margin-bottom: 10px;">
                            <h5 style="margin: 0 0 8px 0; color: #FFD54F;">Filter</h5>
                            <div style="display:flex;flex-direction:column;align-items:flex-start;gap:6px; margin-bottom: 8px;">
                                <label style="color: #FFD54F; font-weight: bold;">Filter Type</label>
                        ...
                        <!-- UNISON (Supersaw/Superunison) -->
                        <div class="sd-row" style="background: rgba(156, 39, 176, 0.15); padding: 10px; border-radius: 6px;">
                            <h5 style="margin: 0 0 8px 0; color: #BA68C8;">Unison (Supersaw)</h5>
                            <div style="display:flex;align-items:center;gap:8px;justify-content:space-between">
                                <label>Voices</label>
                                <input type="range" id="sd-unison-voices" min="1" max="8" value="1" step="1">
                                <span id="sd-unison-voices-val">1</span>
                            </div>
                            <br>
                            <div style="display:flex;align-items:center;gap:8px;justify-content:space-between">
                                <label>Detune Spread</label>
                                <input type="range" id="sd-unison-detune" min="0" max="100" value="20" step="1">
                                <span id="sd-unison-detune-val">20c</span>
                            </div>
                            <br>
                            <div style="display:flex;align-items:center;gap:8px;justify-content:space-between">
                                <label>Pan Spread</label>
                                <input type="range" id="sd-unison-pan" min="0" max="100" value="50" step="1">
                                <span id="sd-unison-pan-val">50%</span>
                            </div>
                        </div>
                        <br>
                        
                        <!-- PWM (Pulse Width Modulation) -->
                        <div class="sd-row" style="background: rgba(255, 152, 0, 0.15); padding: 10px; border-radius: 6px;">
                            <h5 style="margin: 0 0 8px 0; color: #FFB74D;">PWM (Pulse Width Modulation)</h5>
                            <div style="display:flex;align-items:center;gap:8px;justify-content:space-between">
                                <label>Enable</label>
                                <input type="checkbox" id="sd-pwm-enable" style="width: 20px; height: 20px; cursor: pointer;">
                            </div>
                            <br>
                            <div style="display:flex;align-items:center;gap:8px;justify-content:space-between">
                                <label>Rate</label>
                                <input type="range" id="sd-pwm-rate" min="0.1" max="10" value="0.5" step="0.1">
                                <span id="sd-pwm-rate-val">0.5 Hz</span>
                            </div>
                            <br>
                            <div style="display:flex;align-items:center;gap:8px;justify-content:space-between">
                                <label>Depth</label>
                                <input type="range" id="sd-pwm-depth" min="0" max="100" value="50" step="1">
                                <span id="sd-pwm-depth-val">50%</span>
                            </div>
                        </div>
                        <br>
                        
                        <!-- ENVELOPE CONTAINER -->
                        <div class="sd-row" style="background: rgba(244, 67, 54, 0.15); padding: 10px; border-radius: 6px; margin-bottom: 10px;">
                            <h5 style="margin: 0 0 8px 0; color: #EF5350;">Envelope (ADSR)</h5>
                            ...
                            <br>
                            <div style="border-top: 1px solid rgba(244, 67, 54, 0.3); padding-top: 10px; margin-top: 10px;">
                                <div style="display:flex;align-items:center;gap:8px;justify-content:space-between; margin-bottom: 8px;">
                                    <h5 style="color: #EF5350; margin: 0; font-size: 13px;">Envelope → Pitch Modulation</h5>
    ...
    (function ensureSDSliderStyle(){
        ...
        if (!document.getElementById(styleId)) {
            ...
            style.textContent = `
                ...
                .sound-design-controls label { 
                    color: #E0E0E0; 
                    font-size: 13px;
                }
                .sound-design-controls .slider-container label { color: #E0E0E0; }
                .sound-design-controls span { 
                    color: #E0E0E0; 
                    font-size: 12px;
                    min-width: 60px;
                    text-align: right;
                ...
                /* Container-specific slider colors */
                
                /* Master Volume - Green */
                .sound-design-controls div[style*="rgba(76, 175, 80"] input[type="range"] {
                    background: linear-gradient(90deg, #388E3C 0%, #66BB6A 100%) !important;
                }
                .sound-design-controls div[style*="rgba(76, 175, 80"] input[type="range"]::-webkit-slider-runnable-track {
                    background: linear-gradient(90deg, #388E3C 0%, #66BB6A 100%);
                    height: 8px;
                    border-radius: 4px;
                }
                .sound-design-controls div[style*="rgba(76, 175, 80"] input[type="range"]::-webkit-slider-thumb {
                    background: #66BB6A !important;
                    border: 2px solid #81C784;
                    border-radius: 50%;
                }
                .sound-design-controls div[style*="rgba(76, 175, 80"] input[type="range"]::-moz-range-thumb {
                    background: #66BB6A !important;
                    border: 2px solid #81C784;
                    border-radius: 50%;
                }
                .sound-design-controls div[style*="rgba(76, 175, 80"] input[type="range"]::-moz-range-track {
                    background: linear-gradient(90deg, #388E3C 0%, #66BB6A 100%);
                    height: 8px;
                    border-radius: 4px;
                }
                ...
                /* Oscillators - Blue */
                .sound-design-controls div[style*="rgba(33, 150, 243"] input[type="range"] {
                    background: linear-gradient(90deg, #1976D2 0%, #42A5F5 100%) !important;
                }
                .sound-design-controls div[style*="rgba(33, 150, 243"] input[type="range"]::-webkit-slider-runnable-track {
                    background: linear-gradient(90deg, #1976D2 0%, #42A5F5 100%);
                    height: 8px;
                    border-radius: 4px;
                }
                .sound-design-controls div[style*="rgba(33, 150, 243"] input[type="range"]::-webkit-slider-thumb {
                    background: #42A5F5 !important;
                    border: 2px solid #64B5F6;
                    border-radius: 50%;
                }
                .sound-design-controls div[style*="rgba(33, 150, 243"] input[type="range"]::-moz-range-thumb {
                    background: #42A5F5 !important;
                    border: 2px solid #64B5F6;
                    border-radius: 50%;
                }
                .sound-design-controls div[style*="rgba(33, 150, 243"] input[type="range"]::-moz-range-track {
                    background: linear-gradient(90deg, #1976D2 0%, #42A5F5 100%);
                    height: 8px;
                    border-radius: 4px;
                }
                ...
                /* Filter - Yellow/Amber */
                .sound-design-controls div[style*="rgba(255, 193, 7"] input[type="range"] {
                    background: linear-gradient(90deg, #F57C00 0%, #FFB300 100%) !important;
                }
                .sound-design-controls div[style*="rgba(255, 193, 7"] input[type="range"]::-webkit-slider-runnable-track {
                    background: linear-gradient(90deg, #F57C00 0%, #FFB300 100%);
                    height: 8px;
                    border-radius: 4px;
                }
                .sound-design-controls div[style*="rgba(255, 193, 7"] input[type="range"]::-webkit-slider-thumb {
                    background: #FFB300 !important;
                    border: 2px solid #FFD54F;
                    border-radius: 50%;
                }
                .sound-design-controls div[style*="rgba(255, 193, 7"] input[type="range"]::-moz-range-thumb {
                    background: #FFB300 !important;
                    border: 2px solid #FFD54F;
                    border-radius: 50%;
                }
                .sound-design-controls div[style*="rgba(255, 193, 7"] input[type="range"]::-moz-range-track {
                    background: linear-gradient(90deg, #F57C00 0%, #FFB300 100%);
                    height: 8px;
                    border-radius: 4px;
                }
                ...
                /* Unison - Purple */
                .sound-design-controls div[style*="rgba(156, 39, 176"] input[type="range"] {
                    background: linear-gradient(90deg, #7B1FA2 0%, #AB47BC 100%) !important;
                }
                .sound-design-controls div[style*="rgba(156, 39, 176"] input[type="range"]::-webkit-slider-runnable-track {
                    background: linear-gradient(90deg, #7B1FA2 0%, #AB47BC 100%);
                    height: 8px;
                    border-radius: 4px;
                }
                .sound-design-controls div[style*="rgba(156, 39, 176"] input[type="range"]::-webkit-slider-thumb {
                    background: #AB47BC !important;
                    border: 2px solid #BA68C8;
                    border-radius: 50%;
                }
                .sound-design-controls div[style*="rgba(156, 39, 176"] input[type="range"]::-moz-range-thumb {
                    background: #AB47BC !important;
                    border: 2px solid #BA68C8;
                    border-radius: 50%;
                }
                .sound-design-controls div[style*="rgba(156, 39, 176"] input[type="range"]::-moz-range-track {
                    background: linear-gradient(90deg, #7B1FA2 0%, #AB47BC 100%);
                    height: 8px;
                    border-radius: 4px;
                }
                ...
                /* PWM - Orange */
                .sound-design-controls div[style*="rgba(255, 152, 0"] input[type="range"] {
                    background: linear-gradient(90deg, #F57C00 0%, #FFA726 100%) !important;
                }
                .sound-design-controls div[style*="rgba(255, 152, 0"] input[type="range"]::-webkit-slider-runnable-track {
                    background: linear-gradient(90deg, #F57C00 0%, #FFA726 100%);
                    height: 8px;
                    border-radius: 4px;
                }
                .sound-design-controls div[style*="rgba(255, 152, 0"] input[type="range"]::-webkit-slider-thumb {
                    background: #FFA726 !important;
                    border: 2px solid #FFB74D;
                    border-radius: 50%;
                }
                .sound-design-controls div[style*="rgba(255, 152, 0"] input[type="range"]::-moz-range-thumb {
                    background: #FFA726 !important;
                    border: 2px solid #FFB74D;
                    border-radius: 50%;
                }
                .sound-design-controls div[style*="rgba(255, 152, 0"] input[type="range"]::-moz-range-track {
                    background: linear-gradient(90deg, #F57C00 0%, #FFA726 100%);
                    height: 8px;
                    border-radius: 4px;
                }
                ...
                /* Envelope - Red */
                .sound-design-controls div[style*="rgba(244, 67, 54"] input[type="range"] {
                    background: linear-gradient(90deg, #D32F2F 0%, #E57373 100%) !important;
                }
                .sound-design-controls div[style*="rgba(244, 67, 54"] input[type="range"]::-webkit-slider-runnable-track {
                    background: linear-gradient(90deg, #D32F2F 0%, #E57373 100%);
                    height: 8px;
                    border-radius: 4px;
                }
                .sound-design-controls div[style*="rgba(244, 67, 54"] input[type="range"]::-webkit-slider-thumb {
                    background: #E57373 !important;
                    border: 2px solid #EF5350;
                    border-radius: 50%;
                }
                .sound-design-controls div[style*="rgba(244, 67, 54"] input[type="range"]::-moz-range-thumb {
                    background: #E57373 !important;
                    border: 2px solid #EF5350;
                    border-radius: 50%;
                }
                .sound-design-controls div[style*="rgba(244, 67, 54"] input[type="range"]::-moz-range-track {
                    background: linear-gradient(90deg, #D32F2F 0%, #E57373 100%);
                    height: 8px;
                    border-radius: 4px;
                }
    ...
    function startWaveformAnimation() {
        ...
        // PERFORMANCE: Limit to 30 FPS (33ms interval) instead of 60 FPS
        let lastFrameTime = 0;
    ...
    function updateSpeedInRealTime() {
        ...
        if (sample.source && sample.isScheduled) {
            ...
            // If a user uploaded/recorded the sample via the popup, prefer looping the
            // full original sample instead of time-stretching it to fit the grid.
            if (sample.loopWholeSample) {
                basePlaybackRate = 1;
            } else if (sample.isLongSample) {
    ...
    function updateIndividualTempoInRealTime() {
        ...
        if (sample.source && sample.isScheduled && sample.isLongSample) {
            ...
            const longLoopBarDuration = longLoopBeatDuration * 4;
            const desiredLoopDuration = longLoopBarDuration * longLoopLength;
            const basePlaybackRate = sample.loopWholeSample ? 1 : sample.loopDuration / desiredLoopDuration;
    ...
    function initializeSpeedAndTempoControls() {
        ...
        // Throttle helper to reduce update frequency
        let tempoUpdateTimeout = null;
        ...
        individualTempoSlider.addEventListener("input", function () {
            ...
            // Throttle updates to every 50ms for smooth performance
            clearTimeout(tempoUpdateTimeout);
            tempoUpdateTimeout = setTimeout(() => {
        ...
        // Loop whole sample checkbox - updates temporaryEffects and adjusts playback in real time
        const loopWholeCheckbox = document.getElementById("loop-whole-sample");
        if (loopWholeCheckbox) {
            loopWholeCheckbox.addEventListener("change", function () {
                if (temporaryEffects) {
                    temporaryEffects.loopWholeSample = !!this.checked;
                }
                // Update playback behavior immediately for previews
                updateSpeedInRealTime();
                updateIndividualTempoInRealTime();
            });
        }
    ...
    // Ensure the temporary effects include the loopWholeSample flag (persist per-sample choice)
    temporaryEffects.loopWholeSample = (currentPlaying[sampleNumber] && currentPlaying[sampleNumber].loopWholeSample) ? true : false;
        ...
        // Initialize Loop Whole Sample checkbox state
        const loopWholeCheckbox = document.getElementById("loop-whole-sample");
        if (loopWholeCheckbox) {
            loopWholeCheckbox.checked = !!temporaryEffects.loopWholeSample;
        }
    ...
    function initSoundDesignControls() {
        ...
        if (osc1Level) {
            ...
            osc1Level.oninput = () => {
                ...
                osc1LevelVal.textContent = sd.osc1.level + '%';
                // Real-time update for active voices
                if (isPreviewingPianoRoll && pianoRollPreviewNodes[currentSampleForPopup]) {
                    pianoRollPreviewNodes[currentSampleForPopup].soundDesign = sd;
                    Object.values(pianoRollPreviewActiveVoices).forEach(vv => {
                        if (vv && vv.osc1MasterGain) {
                            const masterVol = (sd.masterVolume || 70) / 100;
                            const osc1Lvl = (sd.osc1.level || 50) / 100;
                            vv.osc1MasterGain.gain.value = osc1Lvl * masterVol;
                        }
                    });
                }
            };
                ...
                if (isPreviewingPianoRoll && pianoRollPreviewNodes[currentSampleForPopup]) {
                    ...
                    Object.values(pianoRollPreviewActiveVoices).forEach(vv => {
                        if (vv && vv.osc1Array) {
                            ...
                            vv.osc1Array.forEach((osc, idx) => {
                                // Reapply detune with unison offset if applicable
                                const baseDetune = sd.osc1.detune || 0;
                                const unisonDetune = sd.unison && sd.unison.voices > 1 ? sd.unison.detune || 20 : 0;
                                const voices = sd.unison && sd.unison.voices > 1 ? sd.unison.voices : 1;
                                const voiceDetune = voices > 1 ? ((idx / (voices - 1)) - 0.5) * 2 * unisonDetune : 0;
                                osc.detune.setValueAtTime(baseDetune + voiceDetune, now);
                            });
                        }
                    });
                }
        ...
        if (osc2Level) {
            ...
            osc2Level.oninput = () => {
                ...
                if (isPreviewingPianoRoll && pianoRollPreviewNodes[currentSampleForPopup]) {
                    pianoRollPreviewNodes[currentSampleForPopup].soundDesign = sd;
                    Object.values(pianoRollPreviewActiveVoices).forEach(vv => {
                        if (vv && vv.osc2MasterGain) {
                            const masterVol = (sd.masterVolume || 70) / 100;
                            const osc2Lvl = (sd.osc2.level || 50) / 100;
                            vv.osc2MasterGain.gain.value = osc2Lvl * masterVol;
                        }
                    });
                }
            };
            ...
            osc2Detune.oninput = () => {
                ...
                if (isPreviewingPianoRoll && pianoRollPreviewNodes[currentSampleForPopup]) {
                    ...
                    Object.values(pianoRollPreviewActiveVoices).forEach(vv => {
                        if (vv && vv.osc2Array) {
                            const now = audioContext.currentTime;
                            vv.osc2Array.forEach((osc, idx) => {
                                const baseDetune = sd.osc2.detune || 0;
                                const unisonDetune = sd.unison && sd.unison.voices > 1 ? sd.unison.detune || 20 : 0;
                                const voices = sd.unison && sd.unison.voices > 1 ? sd.unison.voices : 1;
                                const voiceDetune = voices > 1 ? ((idx / (voices - 1)) - 0.5) * 2 * unisonDetune : 0;
                                osc.detune.setValueAtTime(baseDetune + voiceDetune, now);
        ...
        // Unison controls
        if (!sd.unison) {
            sd.unison = { voices: 1, detune: 20, pan: 50 };
        }
        ...
        if (filterType) {
            ...
            filterType.onchange = () => {
                sd.filter.type = filterType.value;
                // Real-time update for active voices
                if (isPreviewingPianoRoll && pianoRollPreviewNodes[currentSampleForPopup]) {
                    pianoRollPreviewNodes[currentSampleForPopup].soundDesign = sd;
                    Object.values(pianoRollPreviewActiveVoices).forEach(vv => {
                        if (vv && vv.filter) vv.filter.type = sd.filter.type;
                    });
                }
            };
        }
        if (filterCutoff) {
            ...
            filterCutoff.oninput = () => {
                ...
                if (isPreviewingPianoRoll && pianoRollPreviewNodes[currentSampleForPopup]) {
                    ...
                    Object.values(pianoRollPreviewActiveVoices).forEach(vv => {
                        if (vv && vv.filter) {
                            vv.filter.frequency.setValueAtTime(Math.max(20, sd.filter.cutoff || 2000), now);
                        }
                    });
                }
            };
        ...
        if (filterRes) {
            ...
            filterRes.oninput = () => {
                ...
                if (isPreviewingPianoRoll && pianoRollPreviewNodes[currentSampleForPopup]) {
                    ...
                    Object.values(pianoRollPreviewActiveVoices).forEach(vv => {
                        if (vv && vv.filter) {
                            vv.filter.Q.setValueAtTime((sd.filter.resonance || 0) / 10, now);
                        }
                    });
                }
            };
    ...
    // Setup mouse interaction for automation canvas (professional multi-point editor)
    ...
    function saveMicrophoneRecording(sampleNumber) {
        ...
        fileReader.onload = function () {
            audioContext.decodeAudioData(fileReader.result).then(buffer => {
                ...
                // Get the button by ID and show indicator immediately
                ...
                if (button) {
                    ...
                    currentPlaying[sampleNumber].button = button;
                }
    ...
    async function applyEffectsSettings() {
        ...
        try {
            ...
            // Persist the loopWholeSample choice (separate flag on currentPlaying) so playback logic can read it
            currentPlaying[currentSampleForPopup].loopWholeSample = !!temporaryEffects.loopWholeSample;
    ...
    function handleSampleUpload(event) {
        ...
        reader.onload = function (e) {
            audioContext.decodeAudioData(e.target.result).then(buffer => {
                ...
                // When user uploads a sample from the effects popup, prefer looping the
                // whole original sample instead of time-stretching it to fit bars.
                currentPlaying[currentSampleForPopup].loopWholeSample = true;
                uploadedFileNames[currentSampleForPopup] = file.name;
                
                // Get the button by ID and show indicator immediately
                const button = document.getElementById(`but${currentSampleForPopup}`);
                if (button) {
                    addCustomIndicator(button);
                    button.classList.remove("no-sample");
                    // Update the stored button reference
                    currentPlaying[currentSampleForPopup].button = button;
                }
    ...
    // Throttle helpers for effect sliders to reduce lag
    let delayUpdateTimeout = null;
    let reverbUpdateTimeout = null;
    ...
    document.getElementById("reverb-decay").addEventListener("input", function () {
        ...
        clearTimeout(reverbUpdateTimeout);
        reverbUpdateTimeout = setTimeout(() => {
            updateReverbInRealTime();
        }, 50);
    });
            ...
            for (let i = 1; i <= 100; i++) {
                if (currentPlaying[i]) {
                    ...
                    if (sample.button || sample.buffer || sample.effects) {
                        ...
                        // Ensure the loopWholeSample flag is persisted even if it's stored separately
                        try {
                            set.samples[i].effects = set.samples[i].effects || {};
                            set.samples[i].effects.loopWholeSample = !!sample.loopWholeSample || !!(sample.effects && sample.effects.loopWholeSample);
                        } catch (e) {
                            // Non-fatal: proceed without loopWholeSample if something unexpected
                            console.warn(`Could not persist loopWholeSample for sample ${i}:`, e);
                        }
                        
                        // Save audio buffer as base64 if it exists
                        // IMPORTANT: Always save custom samples, even if they're long
                        // Only skip if buffer is missing
                        if (sample.buffer) {
                            try {
                                ...
                                console.error(`❌ Error saving buffer for sample ${i}:`, error);
                            }
                        } else if (sample.isCustomSample) {
                            // Skip - no buffer available
                        }
    ...
    function loadSet() {
        try {
            showNotification("Opening file browser...");
            ...
            input.onchange = function(e) {
                ...
                if (file) {
                    showNotification("Reading file... Please wait.");
                    const reader = new FileReader();
                    reader.onload = function(event) {
                        try {
                            // Defer processing to next event loop cycle to allow UI to update
                            setTimeout(() => {
            ...
            // Click must happen ASAP without blocking
            setTimeout(() => {
                input.click();
            }, 10);
        } catch (error) {
    ...
    function processLoadedSet(setJSON) {
        try {
            ...
            showNotification("Loading set... Step 1/4: Stopping playback");
            
            // Stop playback if playing (but do it asynchronously to not block)
            if (isPlaying) {
                setTimeout(() => {
                    playButton.click();
                }, 10);
            ...
            // CRITICAL FIX: Don't reset all 100 samples in main thread - do it asynchronously in batches
            let resetIndex = 0;
            
            function resetSampleBatch() {
                const batchEnd = Math.min(resetIndex + 10, 100);
                
                for (let i = resetIndex + 1; i <= batchEnd; i++) {
                    // ONLY stop if actually scheduled or playing - don't call stopSample() which is heavy
                    if (currentPlaying[i].source && currentPlaying[i].source.stop) {
                        try {
                ...
                if (resetIndex < 100) {
                    // Schedule next batch
                    setTimeout(resetSampleBatch, 5);
                } else {
                    // All reset done - now load settings and samples
                    loadSetSettings(set);
                }
            }
            
            // Start resetting in batches
            resetSampleBatch();
            
        } catch (error) {
            console.error("❌ Error processing loaded set:", error);
            window.isLoadingSet = false;
            showNotification(`Error loading set: ${error.message}`);
        }
    }
    
    // Helper function to load set settings and samples
    function loadSetSettings(set) {
        try {
            showNotification("Loading set... Step 2/4: Loading settings");
            ...
            // Now load samples asynchronously
            setTimeout(() => {
                loadSetSamples(set);
            }, 50);
            ...
            window.isLoadingSet = false;
            showNotification(`Error loading settings: ${error.message}`);
        }
    }
    
    // Helper function to load samples in batches
    function loadSetSamples(set) {
        try {
            showNotification("Loading set... Step 3/4: Loading samples");
            
            const sampleKeys = Object.keys(set.samples || {});
            const totalSamples = sampleKeys.length;
            let loadedCount = 0;
            let sampleIndex = 0;
            
            function loadSampleBatch() {
                const batchEnd = Math.min(sampleIndex + 5, sampleKeys.length);
                
                for (let idx = sampleIndex; idx < batchEnd; idx++) {
                    const key = sampleKeys[idx];
                    const sampleData = set.samples[key];
                    const sampleNumber = parseInt(key);
                    
                    const button = document.getElementById(`but${sampleNumber}`);
                    if (button) {
                        // IMPORTANT: Always assign the button reference so samples can be played
                        currentPlaying[sampleNumber].button = button;
                        ...
                        if (sampleData.buffer) {
                            ...
                            if (sampleData.isCustomSample) {
                                if (typeof addCustomIndicator === 'function') {
                                    addCustomIndicator(button);
                                }
                            }
                        } else {
                        ...
                        // Load buffer if available (do NOT wait for it synchronously)
                        if (sampleData.buffer) {
                            base64ToAudioBuffer(sampleData.buffer)
                                .then(buffer => {
                                    console.log(`✅ Loaded buffer for sample ${sampleNumber}: ${buffer.length} samples, ${buffer.duration.toFixed(2)}s`);
                                    currentPlaying[sampleNumber].buffer = buffer;
                                    ...
                                    // Make sure button reflects that it has audio
                                    if (button) {
                                        button.classList.remove("no-sample");
                                        if (sampleData.isCustomSample) {
                                            addCustomIndicator(button);
                                ...
                                .catch(error => {
                                    console.error(`❌ Could not load buffer for sample ${sampleNumber}:`, error);
                                    button.classList.add("no-sample");
                                });
                        }
                        
                        // Load recorded blob if available (do NOT wait for it)
                        if (sampleData.recordedBlob) {
                            base64ToBlob(sampleData.recordedBlob)
                                .then(blob => {
                                    recordedBlobs[sampleNumber] = blob;
                                })
                                .catch(error => {
                                    console.warn(`⚠️ Could not load recorded blob for sample ${sampleNumber}:`, error);
                                });
                        }
                        ...
                        if (sampleData.effects) {
                            ...
                            // Restore the loopWholeSample flag from the saved effects if present
                            currentPlaying[sampleNumber].loopWholeSample = !!(sampleData.effects && sampleData.effects.loopWholeSample) || !!sampleData.loopWholeSample || false;
                        } else {
                            // Also restore if flag was saved at top-level for backward compatibility
                            currentPlaying[sampleNumber].loopWholeSample = !!sampleData.loopWholeSample || false;
                        }
                ...
                sampleIndex = batchEnd;
                
                // Show progress
                if (sampleIndex % 10 === 0) {
                    showNotification(`Loading samples... ${loadedCount}/${totalSamples}`);
                }
                
                if (sampleIndex < sampleKeys.length) {
                    // Schedule next batch with small delay
                    setTimeout(loadSampleBatch, 10);
                } else {
                    // All samples loaded, now load piano roll
                    setTimeout(() => {
                        loadSetPianoRoll(set);
                    }, 50);
                }
            }
            ...
            window.isLoadingSet = false;
            showNotification(`Error loading samples: ${error.message}`);
        }
    }
    
    // Helper function to load piano roll and finalize
    function loadSetPianoRoll(set) {
        try {
            showNotification("Loading set... Step 4/4: Finalizing");
            ...
            // Reschedule any active samples (but only if they were saved as active)
            for (let i = 1; i <= 100; i++) {
                if (currentPlaying[i].button && currentPlaying[i].buffer && currentPlaying[i].isActive) {
                    ...
                    if (typeof scheduleSampleForNextBar === 'function') {
            ...
            window.isLoadingSet = false;
            showNotification(`Error finalizing: ${error.message}`);
        }
    }
    ...
    function loadAudio(sampleNumber, index) {
        ...
        // Check if sample is already loaded from folder (Sample Library)
        if (currentPlaying[index].buffer && currentPlaying[index].isFromFolder) {

            if (currentPlaying[index].button) {
                currentPlaying[index].button.classList.remove("loading", "no-sample", "error");
            }
            return;
        }
        ...
        // Try to load from default mykicks folder
        ...
        audio.addEventListener("canplaythrough", function () {
            fetch(audio.src).then(response => {
                ...
                currentPlaying[index].isFromFolder = false; // Mark as default sample
                if (currentPlaying[index].button) {
    ...
    function playSampleAtTime(sampleNumber, startTime) {
        ...
        if (effects.pianoRoll && effects.pianoRoll.notes.length > 0) {
            ...
            if (currentPlaying[sampleNumber].isLongSample) {
                ...
                const basePlaybackRate = currentPlaying[sampleNumber].loopWholeSample ? 1 : currentPlaying[sampleNumber].loopDuration / desiredLoopDuration;
                let individualTempo = 1;
    ...
    function initializeFolderSelection() {
        ...
        // Folder selection handler - Enhanced with Electron API
            ...
            try {
                ...
                if (typeof window !== 'undefined' && window.electronAPI && typeof window.electronAPI.selectFolder === 'function') {
                    ...
                    if (folderPath) {
                        ...
                        if (typeof window.electronAPI.loadFolderAudioFiles === 'function') {
                            ...
                            if (audioFiles && audioFiles.length > 0) {
                                ...
                                // Create a map of numbered samples (1.wav -> button 1, 2.mp3 -> button 2, etc.)
                                const numberedSamples = {};
                                audioFiles.forEach(fileName => {
                                    // Extract number from filename (matches 1.wav, 2.mp3, 003.flac, etc.)
                                    const match = fileName.match(/^(\d+)\./);
                                    if (match) {
                                        const num = parseInt(match[1], 10);
                                        if (num >= 1 && num <= 100) {
                                            numberedSamples[num] = fileName;
                                        }
                                    }
                                });
                                
                                console.log(`🎵 Found ${Object.keys(numberedSamples).length} numbered samples:`, numberedSamples);
                                
                                // Load all numbered audio files into sampleBuffers

                                const result = await loadAllAudioFilesFromFolder(folderPath, audioFiles, sampleBuffers);
                                ...
                                if (result.success && result.loadedCount > 0) {
                                    ...
                                    // Auto-load numbered samples into corresponding buttons
                                    Object.keys(numberedSamples).forEach(buttonNum => {
                                        const num = parseInt(buttonNum, 10);
                                        const fileName = numberedSamples[num];
                                        const buffer = sampleBuffers[fileName];
                                        
                                        if (buffer && currentPlaying[num]) {
                                            currentPlaying[num].buffer = buffer;
                                            currentPlaying[num].loopDuration = buffer.duration;
                                            currentPlaying[num].bufferSampleNumber = num;
                                            currentPlaying[num].isFromFolder = true;
                                            currentPlaying[num].folderFileName = fileName;
                                            
                                            if (currentPlaying[num].button) {
                                                currentPlaying[num].button.classList.remove("loading", "no-sample", "error");
                                            }

                                        }
                                    });
                                    
                                    showNotification(`✅ Loaded ${Object.keys(numberedSamples).length} numbered samples from folder`);

                                } else {
                                    showNotification(`⚠️ Failed to load samples: ${result.error || 'Unknown error'}`);
                                    console.warn(`⚠️ Load failed:`, result);
                                }
                            } else {
                                showNotification('⚠️ No audio files found in folder');
                                console.warn(`⚠️ No audio files:`, { folderResult, audioFiles });
                            }
                        } else {
                            showNotification('⚠️ Folder audio loader not available');
                        }
                    }
                } else {
                    // Fallback to prompt-based folder selection for web
    ...
    function updateNoteOverlayWidths() {
        // Lightweight function to update note overlay widths after zoom change
        // Avoids full re-render with initPianoRoll()
        const grid = document.querySelector(".piano-roll-grid");
        if (!grid) return;
        ...
        // Update all note overlays
        const overlays = grid.querySelectorAll('.piano-roll-note-overlay');
        overlays.forEach(overlay => {
            const noteLength = parseFloat(overlay.dataset.length) || 1;
            overlay.style.width = (noteLength * cellWidth) + 'px';
            
            // Also update left position for proper alignment
            const col = parseInt(overlay.dataset.col) || 0;
        ...
        if (zoomDecreaseBtn) {
            zoomDecreaseBtn.addEventListener("click", function() {
                if (pianoRollZoomLevel > 0.5) {
                    ...
                    updateNoteOverlayWidths(); // Update note widths without full re-render
                }
            });
        }
    ...
    function initPianoRoll() {
        ...
        if (pianoRollVirtualization.enabled) {
            ...
            data.notes.forEach(note => {
                ...
                updatedPianoRollGrid.appendChild(noteOverlay);
            });
        }
        ...
        const ensureSD = () => {
            if (!pianoRollData[currentSampleForPopup].soundDesign) {
                pianoRollData[currentSampleForPopup].soundDesign = { 
                    masterVolume: 70,
                    ...
                    unison:{voices:1,detune:20,pan:50},
        ...
        // Initialize all sound design controls with event listeners
        ...
        // SD listeners - REMOVED: Now handled by initSoundDesignControls()
        ...
        if (globalPianoRollGrid && !globalPianoRollGrid.hasAttribute('data-click-handler-attached')) {
            ...
            let draggingNoteData = null; // {note, startRow, startCol, offsetX, offsetY}
            
            // Delete mode checkbox
            const deleteModeCheckbox = document.getElementById('piano-roll-delete-mode');
            
            // Mousedown: Check if clicking on right edge (resize), left edge (move), or empty cell
            globalPianoRollGrid.addEventListener("mousedown", function(e) {
                ...
                if (note) {
                    ...
                    // Check if near left edge of NOTE (MOVE/SELECT LENGTH)
                        ...
                        // Find custom length in list or create display
            ...
            globalPianoRollGrid.addEventListener("mousemove", function(e) {
                ...
                if (isResizingNote && resizingNoteData) {
                    ...
                    const baseCellWidth = 20;
                    const cellWidthPx = baseCellWidth * pianoRollZoomLevel;
                    ...
                    const overlays = globalPianoRollGrid.querySelectorAll('.piano-roll-note-overlay');
                    overlays.forEach(overlay => {
                    ...
                    const baseCellWidth = 20;
                    const baseCellHeight = 20;
                    const cellWidthPx = baseCellWidth * pianoRollZoomLevel;
                    const cellHeightPx = baseCellHeight;
                ...
                if (!isCell && !isOverlay) {
                    globalPianoRollGrid.style.cursor = 'default';
                    return;
                }
                ...
                if (isOverlay) {
                    ...
                    if (mouseX >= cellRect.width - edgeThreshold) {
                        globalPianoRollGrid.style.cursor = 'ew-resize';
                        return;
                    }
                    // Check if near left edge of overlay (move)
                    else if (mouseX <= edgeThreshold) {
                        globalPianoRollGrid.style.cursor = 'move';
                        return;
                    }
                    else {
                        globalPianoRollGrid.style.cursor = 'pointer';
                        return;
                    }
                } else {
    ...
    function playPianoKey(noteName, octave) {
        ...
        const row = octave * 12 + noteIndex;
        
        // Get current sound design settings
        const data = pianoRollData[currentSampleForPopup];
        const soundDesign = data && data.soundDesign ? data.soundDesign : null;
        
        // Create gain node for this preview note
        const gainNode = audioContext.createGain();
        gainNode.connect(masterOutputNode);
        gainNode.gain.value = 0.5; // Preview volume
        
        // Use sound design preview function with 0.4 second duration
        const now = audioContext.currentTime;
        playSoundDesignNoteForPreview(row, now, 0.4, gainNode, soundDesign);
    }
    ...
    function togglePianoRollCell(row, col) {
        ...
        // Re-render to update overlay system
        initPianoRoll();
    }
    ...
    function startPianoRollLoop() {
        ...
        sortedNotes.forEach(note => {
            ...
            if (nodes.soundSource === "piano") {
                ...
                // Get the CURRENT sound design parameters in real-time (not cached)
...
function renderSoundDesignNote(offlineContext, row, time, duration, outputNode, design) {
    ...
    // Apply octave shifts
    const osc1OctaveShift = Math.pow(2, data.osc1.octave || 0);
    const osc2OctaveShift = Math.pow(2, data.osc2.octave || 0);
    const osc1Frequency = frequency * osc1OctaveShift;
    const osc2Frequency = frequency * osc2OctaveShift;
    
    // Unison settings
    const unisonVoices = data.unison && data.unison.voices > 1 ? data.unison.voices : 1;
    const unisonDetune = data.unison ? data.unison.detune || 20 : 20;
    const unisonPan = data.unison ? (data.unison.pan || 50) / 100 : 0.5;
    
    // Create oscillator arrays for unison
    const osc1Array = [];
    const osc2Array = [];
    const osc1GainArray = [];
    const osc2GainArray = [];
    ...
    for (let v = 0; v < unisonVoices; v++) {
        ...
        const osc1Phase = data.osc1.phase || 0;
        const osc2Phase = data.osc2.phase || 0;
        
        const osc1 = createOscillatorWithPhase(offlineContext, data.osc1.wave, osc1Frequency, osc1Phase);
        const osc2 = createOscillatorWithPhase(offlineContext, data.osc2.wave, osc2Frequency, osc2Phase);
        
        osc1.detune.value = (data.osc1.detune || 0) + voiceDetune;
        osc2.detune.value = (data.osc2.detune || 0) + voiceDetune;
        
        const g1 = offlineContext.createGain();
        const g2 = offlineContext.createGain();
    ...
    const osc1MasterGain = offlineContext.createGain();
    const osc2MasterGain = offlineContext.createGain();
    ...
    osc1GainArray.forEach(gain => { gain.gain.value = voiceLevelScale; });
    osc2GainArray.forEach(gain => { gain.gain.value = voiceLevelScale; });
    
    // Set master oscillator levels
    const masterVolume = (data.masterVolume || 70) / 100;
    const osc1Level = (data.osc1.level || 50) / 100;
    const osc2Level = (data.osc2.level || 50) / 100;
    osc1MasterGain.gain.value = osc1Level * masterVolume;
    osc2MasterGain.gain.value = osc2Level * masterVolume;
    ...
    if (data.envelope.pitchMod && data.envelope.pitchMod.enabled && data.envelope.pitchMod.amount !== 0) {
        const pitchAmount = data.envelope.pitchMod.amount;
        osc1Array.forEach(osc => {
            const startFreq = osc.frequency.value * Math.pow(2, pitchAmount / 12);
            const endFreq = osc.frequency.value;
            osc.frequency.setValueAtTime(startFreq, time);
            if (attack + decay > 0) {
                osc.frequency.exponentialRampToValueAtTime(Math.max(20, endFreq), time + attack + decay);
            } else {
                osc.frequency.setValueAtTime(endFreq, time + 0.001);
            }
    ...
    if (data.pwm && data.pwm.enabled && data.pwm.rate > 0 && data.pwm.depth > 0) {
        const pwmRate = data.pwm.rate; // Hz
        const pwmDepth = data.pwm.depth / 100; // 0-1 range
        const stopAt = time + duration + Math.max(0, release) + 0.05;
        
        // Create PWM LFO for each oscillator in osc1Array
        osc1Array.forEach((osc, idx) => {
            const pwmLFO = offlineContext.createOscillator();
            const pwmGain = offlineContext.createGain();
        ...
        // Create PWM LFO for each oscillator in osc2Array
    ...
    osc1Array.forEach(osc => { osc.start(time); osc.stop(stopAt); });
    osc2Array.forEach(osc => { osc.start(time); osc.stop(stopAt); });
}
...
function playSoundDesignNoteForPreview(row, time, duration, gainNode, design) {
    ...
    for (let v = 0; v < unisonVoices; v++) {
        ...
        const osc1 = createOscillatorWithPhase(audioContext, data.osc1.wave, osc1Frequency, osc1Phase);
        const osc2 = createOscillatorWithPhase(audioContext, data.osc2.wave, osc2Frequency, osc2Phase);
    ...
    if (data.envelope.pitchMod && data.envelope.pitchMod.enabled && data.envelope.pitchMod.amount !== 0) {
        ...
        osc1Array.forEach(osc => {
            ...
            if (attack + decay > 0) {
                ...
                osc.frequency.setValueAtTime(endFreq, now + 0.001);
            }
            osc.frequency.setValueAtTime(endFreq, now + duration);
        });
        osc2Array.forEach(osc => {
            const startFreq = osc.frequency.value * Math.pow(2, pitchAmount / 12);
            const endFreq = osc.frequency.value;
    ...
    if (data.pwm && data.pwm.enabled && data.pwm.rate > 0 && data.pwm.depth > 0) {
        const pwmRate = data.pwm.rate; // Hz
        const pwmDepth = data.pwm.depth / 100; // 0-1 range
        const stopAt = now + duration + Math.max(0, release) + 0.05;
    ...
    // Start and stop all oscillators
    const stopAt = now + duration + Math.max(0, release);
    osc1Array.forEach(osc => { osc.start(now); osc.stop(stopAt); });
    osc2Array.forEach(osc => { osc.start(now); osc.stop(stopAt); });
    
    // Return live nodes for real-time modulation
    return { osc1Array, osc2Array, osc1GainArray, osc2GainArray, osc1MasterGain, osc2MasterGain, filter, env, stopAt };
}
